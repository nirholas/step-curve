...
/**
 * @title DeployStepCurve
 * @notice Deploys StepCurve deterministically to any chain with a Uniswap v4 `PoolManager`.
 *
...
contract DeployStepCurve is Script {
    ...
    function run() external {
        ...
        console2.log("StepCurve ", predicted);
        ...
        require(
            keccak256(bytes(IHookMetadata(address(hook)).hookName())) == keccak256(bytes("StepCurve")),
