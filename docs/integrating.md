# Integrating StepCurve

## From Solidity

```solidity
import {StepCurveHook} from "step-curve/src/hooks/StepCurveHook.sol";
...
const address = hookAddress("step-curve", 8453);              // Base
...
```solidity
IHookMetadata(hookAddress).hookName();   // "StepCurve"
...
More at https://step-curve.pages.dev.
